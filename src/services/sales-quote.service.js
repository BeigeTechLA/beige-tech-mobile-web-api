...
function deriveQuoteAcceptanceEmailPayload(quoteDetails) {
  ...
  return {
    ...
    created_by_user_id: quoteDetails.created_by_user_id || quoteDetails.created_by?.id || null,
    created_by_name: quoteDetails.created_by?.name || null,
    created_by_email: quoteDetails.created_by?.email || null,
    assigned_sales_rep_id: quoteDetails.assigned_sales_rep_id || quoteDetails.assigned_sales_rep?.id || null,
    assigned_sales_rep_email: quoteDetails.assigned_sales_rep?.email || null,
