...
router.get('/equipment', authenticate, creator.getMyEquipment);
router.get('/equipment/:equipment_id', authenticate, creator.getMyEquipmentById);
router.post('/equipment', authenticate, creator.saveMyEquipment);
router.post('/equipment/:crew_equipment_id/photos', authenticate, creator.uploadCrewEquipmentPhotos);
router.delete('/equipment/:id', authenticate, creator.deleteMyEquipment);
...
router.post('/equipment/delete-photo', authenticate, creator.deleteEquipmentPhoto);
