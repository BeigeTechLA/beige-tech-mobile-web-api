...
router.get('/credit/summary', optionalAuth, clientAffiliateOverviewView, client.getClientCreditSummary);
router.get('/credit/history', optionalAuth, clientAffiliateOverviewView, client.getClientCreditHistory);
...
router.get('/get-project/:project_id', optionalAuth, clientDashboardView, client.getProjectDetailsForUser);
